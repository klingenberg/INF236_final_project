...
\begin{tikzpicture}
\begin{axis}[
    title={Comparison of parallel matmul and parallel strassen to the sequential strassen with different amount of threads for matrices with size 256x256},
    xlabel={\#threads},
    ylabel={speedup},
    xmin=0, xmax=8,
    ymin=0, ymax=22,
    xtick={0, 1, 2, 5, 10, 20, 40, 60},
    ytick={0, 5, 10, 15, 20},
    legend pos=outer north east,
    xmajorgrids=true,
    ymajorgrids=true,
	...
	% normal strassen
	\addplot[color=gradient2, mark=*, only marks] table [x=config, y=strassen_vs_simple_parallel, col sep=comma] {result256.csv};
	% parallel matmul
	\addplot[color=gradient3, mark=*, only marks] table [x=config, y=strassen_vs_strassen_2layers, col sep=comma] {result256.csv};
	% parallel strassen
	\addplot[color=gradient4, mark=*, only marks] table [x=config, y=strassen_vs_strassen_recursive, col sep=comma] {result256.csv};
    
    \legend{matmul, strassen, parallel matmul, parallel strassen}
\end{axis}
\end{tikzpicture}
...
\begin{axis}[
	...
	% normal strassen
	\addplot[color=gradient2, mark=*, only marks] table [x=config, y=strassen_vs_simple_parallel, col sep=comma] {result512.csv};
	% parallel matmul
	\addplot[color=gradient3, mark=*, only marks] table [x=config, y=strassen_vs_strassen_2layers, col sep=comma] {result512.csv};
	% parallel strassen
...
\begin{axis}[
	...
	% normal strassen
	\addplot[color=gradient2, mark=*, only marks] table [x=config, y=strassen_vs_simple_parallel, col sep=comma] {result1024.csv};
	% parallel matmul
	\addplot[color=gradient3, mark=*, only marks] table [x=config, y=strassen_vs_strassen_2layers, col sep=comma] {result1024.csv};
	% parallel strassen
...
\begin{axis}[
	...
	% normal strassen
	\addplot[color=gradient2, mark=*, only marks] table [x=config, y=strassen_vs_simple_parallel, col sep=comma] {result2048.csv};
	% parallel matmul
	\addplot[color=gradient3, mark=*, only marks] table [x=config, y=strassen_vs_strassen_2layers, col sep=comma] {result2048.csv};
	% parallel strassen
...
\begin{axis}[
	...
	% normal strassen
	\addplot[color=gradient2, mark=*, only marks] table [x=config, y=strassen_vs_simple_parallel, col sep=comma] {result4096.csv};
	% parallel matmul
	\addplot[color=gradient3, mark=*, only marks] table [x=config, y=strassen_vs_strassen_2layers, col sep=comma] {result4096.csv};
	% parallel strassen
...
\begin{axis}[
	...
	% normal strassen
	\addplot[color=gradient2, mark=*, only marks] table [x=config, y=strassen_vs_simple_parallel, col sep=comma] {result8192.csv};
	% parallel matmul
	\addplot[color=gradient3, mark=*, only marks] table [x=config, y=strassen_vs_strassen_2layers, col sep=comma] {result8192.csv};
	% parallel strassen
