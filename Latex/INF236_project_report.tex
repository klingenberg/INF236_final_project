...
\subsection{Comparison of parallel matmul and parallel strassen to the sequential strassen with different amount of threads}
...
\subsection{Running times for all implemeted algorithms and different number of threads}
