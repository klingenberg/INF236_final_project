...
Figure \ref{fig:running_times_threads} plot shows that for parallel Strassen's algorithm with cutoff 512 is optimal
to use 40 threads. With more threads, the code is slower again. Unlike that simple parallel
matrix multiplication is faster with 60 threads than with 40.
