...
but in practice it runs faster than with three nested loops that are indexed in $kij$ order. %why kij?
...
for example z-ordering \ref{z_diagram}, \ref{z_mem}.
...
in row-wise order \ref{z_partly}. Functions for reordering matrices to this layout and back are implemented
in \texttt{z\_order.c} file.
