...
\begin{axis}[
	...
	% normal strassen
	\addplot[color=gradient2, mark=*, only marks] table [x=config, y=size2, col sep=comma] {results.csv};
	% parallel matmul
	\addplot[color=gradient3, mark=*, only marks] table [x=config, y=size3, col sep=comma] {results.csv};
	% parallel strassen
	\addplot[color=gradient4, mark=*, only marks] table [x=config, y=size4, col sep=comma] {results.csv};
